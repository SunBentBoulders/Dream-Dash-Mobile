...
//    goFull();
    ...
    var ledge = platforms.create(this.game.width/2, this.game.height/1.5, 'ground');
    ...
    this.player = this.game.add.sprite(this.game.width/25, this.game.height - this.game.height/4, 'dude');
